...
class TurnTest < MiniTest::Test
  ...
  def test_pile_cards_war
    ...
    assert_equal [card2, card1, card5, card4, card3, card6], turn.pile_cards
  ...
  def test_award_spoils_basic
    # skip
    card1 = Card.new(:heart, 'Jack', 11)# e a
    card2 = Card.new(:heart, '10', 10)# e a
    card3 = Card.new(:heart, '9', 9)# e a
    card4 = Card.new(:diamond, 'Jack', 11)#
    card5 = Card.new(:heart, '8', 8)# e a
    card6 = Card.new(:diamond, 'Queen', 12)#
    card7 = Card.new(:heart, '3', 3)#
    card8 = Card.new(:diamond, '2', 2)# e a
    deck1 = Deck.new([card1, card2, card5, card8])
    deck2 = Deck.new([card3, card4, card6, card7])
    player1 = Player.new('Megan', deck1)
    player2 = Player.new('Aurora', deck2)
